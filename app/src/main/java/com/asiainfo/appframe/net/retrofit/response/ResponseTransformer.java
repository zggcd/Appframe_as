package com.asiainfo.appframe.net.retrofit.response;

import com.asiainfo.appframe.net.retrofit.Exception.ApiException;
import com.asiainfo.appframe.net.retrofit.Exception.CustomException;
