 ...
 *
 */
public class PostFrameView_type2 extends RelativeLayout {
  ...
  //Handler  
	...
	public PostFrameView_type2(Context context) {
		super(context);
    ...
    private void initUI(Context context){ 
        ...
        for (int i = 0; i < mList_imgUrl.size(); i++) {
        	...
        	if(extendsabilityalias != null && extendsabilityalias != ""){
        		...
        		flp.setMargins((screenWH[1] / 2 - 30 + 20) * (i + 1) - 60 + 20, 0, 0, 0);
        	...
        	LinearLayout.LayoutParams space_params = new LinearLayout.LayoutParams(20,screenWH[1] / 2 - 10);
        	content.addView(space_view, space_params);
        	
        	ImageView view =  new ImageView(context);
            view.setTag(mList_imgUrl.get(i));
            view.setScaleType(ScaleType.FIT_XY);
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(screenWH[1] / 2 - 30,screenWH[1] / 2 - 30);
