...
import com.asiainfo.appframe.activity.HomePagerActivity;
import com.asiainfo.appframe.activity.WebControlerActivity;
import com.asiainfo.appframe.activity.WelcomeActivity;
import com.asiainfo.appframe.activity.WelcomeNewActivity;
...
public class FloorMenuBar1View extends LinearLayout {
    ...
    //DATA
    List<ChildsBean> mList_FloorBasicInfos = new ArrayList<>();

    public FloorMenuBar1View(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public void setFloorEntryMenuViewInfo(List<ChildsBean> list){
        this.mList_FloorBasicInfos = list;
        Collections.sort(mList_FloorBasicInfos, new Comparator<ChildsBean>() {

            @Override
            public int compare(ChildsBean lhs, ChildsBean rhs) {
    ...
    public FloorMenuBar1View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FloorMenuBar1View(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    String imageUrl = mList_FloorBasicInfos.get(i * 8).getPicurl();
                    String imageUrl = mList_FloorBasicInfos.get(i * 8).getImgUrl();
...
//                    picasso.load(R.mipmap.task).into(iv_00);
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8));
                        }
                    });
                }else{
                ...
                if( i * 8 + 1 < mList_FloorBasicInfos.size() ){
                    ...
                    String imageUrl = mList_FloorBasicInfos.get(i * 8 + 1).getImgUrl();
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 1).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 1));
                        }
                    });
                }else{
                ...
                if( i * 8 + 2 < mList_FloorBasicInfos.size() ){
                    ...
                    String imgUrl = mList_FloorBasicInfos.get(i * 8 + 2).getImgUrl();
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 2).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 2));
                        }
                    });
                }else{
                ...
                if( i * 8 + 3 < mList_FloorBasicInfos.size() ){
                    ...
                    Picasso.with(context).load(mList_FloorBasicInfos.get(i * 8 + 3).getImgUrl()).into(iv_00, new Callback() {
                        @Override
                        public void onSuccess() {
                            iv_00.setBackground(null);
                        }
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 3).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 3));
                        }
                    });
                }else{
                ...
                if( i * 8 + 4 < mList_FloorBasicInfos.size() ){
                    ...
                    Picasso.with(context).load(mList_FloorBasicInfos.get(i * 8 + 4).getImgUrl()).into(iv_00, new Callback() {
                        @Override
                        public void onSuccess() {
                            iv_00.setBackground(null);
                        }
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 4).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 4));
                        }
                    });
                }else{
                ...
                if( i * 8 + 5 < mList_FloorBasicInfos.size() ){
                    ...
                    String imgUrl = mList_FloorBasicInfos.get(i * 8 + 5).getImgUrl();
//                    picasso.load(R.mipmap.task).into(iv_00);
                    Picasso.with(context).load(imgUrl).into(iv_00, new Callback() {
                        @Override
                        public void onSuccess() {
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 5).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 5));
                        }
                    });
                }else{
                ...
                if( i * 8 + 6 < mList_FloorBasicInfos.size() ){
                    ...
                    String imgUrl = mList_FloorBasicInfos.get(i * 8 + 6).getImgUrl();
                    Picasso.with(context).load(imgUrl).into(iv_00, new Callback() {
                        @Override
                        public void onSuccess() {
                            iv_00.setBackground(null);
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 6).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 6));
                        }
                    });
                }else{
                ...
                if( i * 8 + 7 < mList_FloorBasicInfos.size() ){
                    ...
                    String imgUrl = mList_FloorBasicInfos.get(i * 8 + 7).getImgUrl();
                    Picasso.with(context).load(imgUrl).into(iv_00, new Callback() {
                        @Override
                        public void onSuccess() {
                            iv_00.setBackground(null);
                    ...
                    tv_00.setText(mList_FloorBasicInfos.get(i * 8 + 7).getName());
                    int finalI = i;
...
//                            jumpToWeb("http://zc.testpub.net/files/schedule/index.html");
                            ...
                            itemClick(mList_FloorBasicInfos.get(finalI * 8 + 7));
                        }
                    });
                }else{
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    if(response.getCode() == 1000){
                        Intent intent = new Intent(context, WelcomeNewActivity.class);
                        context.startActivity(intent);
                        ((HomePagerActivity)context).finish();
                        break;
                    }
                    ...
                    itemClick(mList_FloorBasicInfos.get(msg.arg1));
