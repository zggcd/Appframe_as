...
public class FloorEntryBar2View  extends LinearLayout {
    ...
    ChildsBeanX mParentInfo;

    public FloorEntryBar2View(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public void setFloorEntry1ViewInfo(ChildsBeanX info) {
        this.mParentInfo = info;
        this.mList_FloorBasicInfos = info.getChilds();
    ...
    public FloorEntryBar2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FloorEntryBar2View(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initData() {
        ...
        if (mList_FloorBasicInfos.size() > 0) {
            ...
            String entry1_menu_name = mList_FloorBasicInfos.get(0).getName();
            String entry1_menu_describe1 = mList_FloorBasicInfos.get(0).getAttrVals().get(0).getVal();
            tv_entry1_name.setText(mParentInfo.getName());
            tv_entry1_menu_name1.setText(entry1_menu_name);
            tv_entry1_menu_describe1.setText(entry1_menu_describe1);
            String iconUrl1 = mList_FloorBasicInfos.get(0).getImgUrl();
            ...
            rl_entry1_1.setOnClickListener(click -> {
                ...
                itemClick(mList_FloorBasicInfos.get(0));
                // TODO Auto-generated method stub
//                ApiClient.getClickUrl(handler, 4, mList_FloorBasicInfos.get(0).getAbilityalias());
            });

            String entry1_menu_name2 = mList_FloorBasicInfos.get(1).getName();
            String entry1_menu_describe2 = mList_FloorBasicInfos.get(1).getAttrVals().get(0).getVal();
            tv_entry1_menu_name2.setText(entry1_menu_name2);
            tv_entry1_menu_describe2.setText(entry1_menu_describe2);
            String iconUrl2 = mList_FloorBasicInfos.get(1).getImgUrl();
            ...
            rl_entry1_2.setOnClickListener(click -> {
                ...
                itemClick(mList_FloorBasicInfos.get(1));
                // TODO Auto-generated method stub
