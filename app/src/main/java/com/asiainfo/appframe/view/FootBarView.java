...
public class FootBarView extends LinearLayout {
    ...
    private List<FootbarsBean> mList_floorBasicInfos = new ArrayList<FootbarsBean>();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:					//跳转web页面
                    ...
                    if(mList_floorBasicInfos.get(msg.arg1).getPicurl() != null && mList_floorBasicInfos.get(msg.arg1).getPicurl().length() > 0){
...
//                    ((MainActivity)mContext).refreshUI(homePageInfo);
    ...
    public void setFloorBasicInfos(List<FootbarsBean> list){
        this.mList_floorBasicInfos = list;

        Collections.sort(mList_floorBasicInfos, new Comparator<FootbarsBean>() {

            @Override
            public int compare(FootbarsBean lhs, FootbarsBean rhs) {
    ...
    private void initData(){
        ...
        new FootBarView.GetListTask().execute("");
    }
    ...
    private void initUI(Context context){
        ...
        for (int i = 0; i < typeSize; i++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(screenWH[1] / typeSize, LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    class GetListTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                ...
                for (FootbarsBean info : mList_floorBasicInfos) {
