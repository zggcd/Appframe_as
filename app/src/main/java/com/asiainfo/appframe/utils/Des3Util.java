...
public class Des3Util {
	/* 密钥 */
    public static String secretKey = "2013%jiangsu&&iam##admin" ;
    // 向量
    ...
    public static String encode(String plainText) throws Exception {
        Key deskey = null ;
        byte[] apec = secretKey.getBytes();
        DESKeySpec spec = new DESKeySpec(secretKey.getBytes(encoding));
...
//        return android.util.Base64.encodeToString(encryptData, android.util.Base64.DEFAULT);
    ...
    public static String padding(String str) {
        ...
        try {
            ...
            return new String(newByteArray, "UTF-8");
