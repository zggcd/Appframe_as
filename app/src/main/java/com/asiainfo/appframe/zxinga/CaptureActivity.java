...
import com.asiainfo.appframe.zxinga.CameraManager;
import com.asiainfo.appframe.zxinga.CaptureActivityHandler;
import com.asiainfo.appframe.zxinga.DecodeFormatManager;
import com.asiainfo.appframe.zxinga.DecodeHandler;
import com.asiainfo.appframe.zxinga.InactivityTimer;
import com.asiainfo.appframe.zxinga.ViewfinderView;
...
//		mImgFlashlight.setImageResource(R.drawable.flashlight_off);
		mImgFlashlight.setImageResource(ResourceUtil.getDrawableId(mContext, "flashlight_off"));
...
//		setContentView(R.layout.hybrid_sdk_layout_zxing);
		setContentView(ResourceUtil.getLayoutId(mContext, "hybrid_sdk_layout_zxing"));
...
//		mTvBack = (TextView) findViewById(R.id.tv_back);
		mTvBack = (TextView) findViewById(ResourceUtil.getId(mContext, "tv_back"));
...
//				mImgFlashlight.setImageResource(R.drawable.flashlight_on);
				mImgFlashlight.setImageResource(ResourceUtil.getDrawableId(mContext, "flashlight_on"));
			}
		}
	}
